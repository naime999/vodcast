            ...
            <td align="center">
                <div class="email-container">
                    ...
                    <div class="email-header">
                        <h1>{{ $data['app_name']->value }} Client Verification</h1>
                    </div>

                    <!-- Body -->
                    <div class="email-body">
                        <h2>Hello, {{ $data['client']->first_name.' '.$data['client']->last_name }}!</h2>
                        <p>Your new account create in <strong>{{ $data['app_name']->value }}</strong>, please verify and add new password your account</p>
                        <br/>
                        <p><a target="_blank" href="{{ $data['verify_url'] }}" class="button">Verify</a></p>
                    </div>
