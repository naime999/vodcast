<div class="modal fade" id="yEditPlaylistModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Youtube Playlist</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="edit-youtube-playlist" class="row" method="POST" action="{{ route('users.youtube.playlist.update') }}">
                    @csrf
            ...
            <div class="modal-footer">
                ...
                <button class="btn btn-success"
                    onclick="event.preventDefault(); document.getElementById('edit-youtube-playlist').submit();">
                    Update
                </button>
            </div>
        </div>
